...
func Test_HandlerError_when_endpoints_returns_internal_error(t *testing.T) {
	assert := assert.New(t)
...
func Test_HandlerError_when_endpoints_returns_domain_error(t *testing.T) {
...
func Test_HandlerError_when_endpoints_returns_obj_and_status(t *testing.T) {
